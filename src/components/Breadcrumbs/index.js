 ...
 * @Author: your name
 * @Date: 2019-08-02 11:20:45
 * @LastEditTime: 2019-08-20 13:17:09
...
class Breadcrumbs extends PureComponent {
  ...
  itemRender2 = (route, i, routes) => {
    ...
    return notTo ? (
      ...
      <a onClick={ ()=>this.linkTo(to) } key={`${route.breadcrumbName}${Math.random()}`}>{ route.breadcrumbName }</a>
    )
  }
  linkTo = (url) => {
